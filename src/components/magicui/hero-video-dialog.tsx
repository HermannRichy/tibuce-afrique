        ...
        <div className={cn("relative", className)}>
            ...
            >
                <Image
                    ...
                    width={1024}
                    height={600}
                    className={`${styles.mypath} w-full max-w-[1024px] lg:h-[600px] object-cover mx-auto rounded-2xl border shadow-lg transition-all duration-200 ease-out group-hover:brightness-[0.8] lg:my-clip-path`}
                />
