        ...
        <Dialog open={open} onOpenChange={onClose}>
            <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm">
                                    {inscription.teamRepresentative}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    {(inscription.projectTitle ||
                        inscription.projectDescription) && (
                        <>
                            <div className="space-y-4">
                                <h3 className="text-lg font-semibold flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <div className="mt-1">
                                        <BadgeList
                                            items={inscription.selectedTrack}
                                            variant="secondary"
                                            emptyMessage="Aucun volet sélectionné"
                                        />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <p className="text-sm">
                                    ...
                                    {inscription.paymentMethodOther && (
                                        <span className="text-muted-foreground">
                                            {" "}
                                            ({inscription.paymentMethodOther})
                                        </span>
