    ...
    try {
        ...
        const inscription = await prisma.inscription.create({
            data: {
                ...
                organizationOther: data.organizationOther || "N/A",
                numberOfMembers: parseInt(data.numberOfMembers),
                projectTitle: data.projectTitle || "N/A",
                projectDescription: data.projectDescription || "N/A",
                paymentMethod: data.paymentMethod,
                paymentMethodOther: data.paymentMethodOther || "N/A",
                ...
                participant1StatusOther: data.participant1StatusOther || "N/A",
                ...
                participant2StatusOther: data.participant2StatusOther || "N/A",
                participant3Name: data.participant3Name || "N/A",
                participant3Phone: data.participant3Phone || "N/A",
                ...
                participant3StatusOther: data.participant3StatusOther || "N/A",
